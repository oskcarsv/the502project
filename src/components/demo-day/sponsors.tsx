  ...
  return (
    <>
      ...
      <DemoSponsorSection
        ...
        attribution="Este apoyo es parte del programa Codex Ambassadors."
      />
      ...
      <DemoSponsorSection
        ...
        attribution="En colaboración con Walter Morales, Regional Lead de Centroamérica. Oscar Morales, Cursor Ambassador."
      />
    </>
  );
}
