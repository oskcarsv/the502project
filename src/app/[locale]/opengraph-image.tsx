      ...
      >
        ...
        >
          <div style={{ display: "flex" }}>
            <span style={{ marginRight: 36 }}>+700 builders</span>
            <span style={{ marginRight: 36 }}>+25 eventos</span>
            <span style={{ marginRight: 36 }}>+1000 asistentes</span>
            <span>+8 sponsors</span>
          </div>
